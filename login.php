...
<div class="container">
	<div class="row justify-content-md-center">
		<div class="col col-md-4">
			...
			<div class="card">
			<center><div class="card-header"> تسجيل الدخول </div></center>
				<div class="card-body">
					<form method="post" id="patient_login_form">
						...
						<div class="form-group text-center">
							...
							<input type="submit" name="patient_login_button" id="patient_login_button" class="btn btn-primary" value="تسجيل الدخول" />
						</div>

						<div class="form-group text-center">
							<p><a href="register.php">تسجيل</a></p>
						</div>
					</form>
				</div>
			</div>
