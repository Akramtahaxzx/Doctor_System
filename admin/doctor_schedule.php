...
?>
                    ...
                    <!-- Page Heading -->
                    <center><h1 class="h3 mb-4 text-gray-800">نظام جدول للطبيب</h1></center>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">قائمة جدول الطبيب</h6>
                            	</div>
    	...
    	<form method="post" id="doctor_schedule_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">إضافة جدول الطبيب</h4>
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>تحديد الطبيب</label>
                        <select name="doctor_id" id="doctor_id" class="form-control" required>
                            <option value="">تحديد الطبيب</option>
                            <?php
                            $object->query = "
                    ...
                    <div class="form-group">
                        <label>معدل وقت الاستشارة</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-clock"></i></span>
                            </div>
                            <select name="average_consulting_time" id="average_consulting_time" class="form-control" required>
                                <option value="">حدد مدة الاستشارة</option>
                                <?php
                                $count = 0;
                                for($i = 1; $i <= 15; $i++)
                                {
                                    $count += 5;
                                    echo '<option value="'.$count.'">'.$count.' دقائق</option>';
                                }
                                ?>
                            </select>
                        </div>
