...
?>
                    ...
                    <!-- Page Heading -->
                    <center>  <h1 class="h3 mb-4 text-gray-800">نظام المريض</h1></center> 
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">قائمه المرضى</h6>
                            	</div>
                                ...
                                <table class="table table-bordered" id="patient_table" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>اسم الاول</th>
                                            <th>اسم الاخير</th>
                                            <th>الايميل الشخصي</th>
                                            <th>رقم الهاتف</th>
                                            <th>تاكيد ايميل الشخصي</th>
                                            <th>العملية</th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal_title">معلومات المريض</h4>
