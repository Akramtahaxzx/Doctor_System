                                ...
                                <!--<div class="row">
                                    <div class="col-md-6">!-->
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>البريد الالكتروني للطبيب <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label>رقم الهاتف الطبيب <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label>تاريخ ولادة للطبيب</label>
                                        ...
                                        <div class="form-group">
                                            <label>صورة للطبيب <span class="text-danger">*</span></label>
                                            <br />
