...
?>
                    ...
                    <!-- Page Heading -->
					<center>  <h1 class="h3 mb-4 text-gray-800">نظام الطبيب</h1></center> 
    	...
    	<form method="post" id="doctor_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">اضافة طبيب</h4>
        		...
        		<div class="modal-body">
        			<span id="form_message"></span>
		          	<div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>ايميل الشخصي للطبيب <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label>كلمة المرور للطبيب <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>رقم الهاتف للطبيب <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>تاريخ ولادة الطبيب </label>
