...
<body class="text-center">
    <main class="form-signin">
         <form method="post" id="login_form">
            <h1 class="h3 mb-3 fw-normal">نظام حجز مواعيد الاطباء</h1>
            <span id="error"></span>
            ...
            <div class="form-group">
                <button type="submit" name="login_button" id="login_button" class="btn btn-primary btn-user btn-block">تسجيل دخول</button>
            </div>
        </form>
    </main>
